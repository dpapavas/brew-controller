...
/* Bang-bang */
struct pid temperature_pid = {INFINITY, INFINITY, 0, SET};

/* P */
/* struct pid temperature_pid = {0.5 * K_U, INFINITY, 0, SET}; */

/* PI */
/* struct pid temperature_pid = {0.2 * K_U, 0.45 * T_U, 0, SET}; */

/* PD */
/* struct pid temperature_pid = {0.8 * K_U, INFINITY, T_U / 8.0, SET}; */

/* Classic PID */
/* struct pid temperature_pid = {0.6 * K_U, 0.5 * T_U, T_U / 8.0, SET}; */

/* Pessen integral rule */
/* struct pid temperature_pid = {0.7 * K_U, 0.4 * T_U, 0.15 * T_U, SET}; */

/* Some overshoot */
/* struct pid temperature_pid = {K_U / 3.0, 0.5 * T_U, T_U / 3.0, SET}; */

/* No overshoot */
/* struct pid temperature_pid = {0.2 * K_U, 0.5 * T_U, T_U / 3.0, SET}; */
#endif
